...
if ($local) {
   ...
   // $debug = TRUE;
    ...
    function class_loader($class) {
			...
			require($_SERVER['DOCUMENT_ROOT'].$_SESSION['rootfolder'].'/dashboard/esd/classes/'.$class.'.class.php');
    ...
    function class_loader($class) {
			...
			require($_SERVER['DOCUMENT_ROOT'].$_SESSION['rootfolder'].'/esd/classes/'.$class.'.class.php');
