...
if ($local){
	...
	$root = $_SERVER['DOCUMENT_ROOT'].'/gieqs/dashboard/esd/';
	$roothttp = 'http://' . $_SERVER['HTTP_HOST'].'/dashboard/esd/';
	require($_SERVER['DOCUMENT_ROOT'].'/gieqs/dashboard/esd/includes/config.inc.php');
}else{
	$root = $_SERVER['DOCUMENT_ROOT'].'/gieqs/esd/';
	$roothttp = 'http://' . $_SERVER['HTTP_HOST'].'/gieqs/esd/';

	require($_SERVER['DOCUMENT_ROOT'].'/gieqs/esd/includes/config.inc.php');
