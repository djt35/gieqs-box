...
$parameterStartTimeCET = new DateTime('06:00:00', $serverTimeZoneNav);
$parameterEndTimeCET = new DateTime('09:00:00', $serverTimeZoneNav);
...
if ($debug){
    ...
    //$currentNavTime = new DateTime('2021-03-13 07:30:00', $serverTimeZoneNav);  //REMOVE AFTER TEST
...
if ($audience){
    ...
    if ($audience == '1'){
        ...
        $audienceMembers = $userFunctions->getMailListExpandedNoOptOut();
        ...
        $audienceMembersids = $assetManager->getOwnersAssetPlainArrayEmails($emails->getaudience_specify());
        $audienceMembers = $userFunctions->getEmails($audienceMembersids);
        ...
        $audienceMembersCheck = $emails->getaudience_specify();
        
        
            preg_match_all("/[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}\b/i", $audienceMembersCheck, $matches);
        
        
         if ($debug){
             
             print_r($audienceMembersCheck);
            ...
            if (!($matches)){
                ...
                echo 'No matches for email addresses found in the specify audience field';
            }
        }
        
        $audienceMembers = $matches[0];
    ...
    $audienceMembers = $userFunctions->getMailListServices(); 
        ...
        echo PHP_EOL;
         echo 'total population is';
        print_r($populationDenom);
        
        
        array_values(array_unique($populationDenom, SORT_REGULAR));
        
        
        echo PHP_EOL;
        echo 'sorted as unique';
        print_r($populationDenom);

        //$populationDenom = ['djtate@gmail.com']; //TEST REMOVE FOR LIVE
        ...
        echo PHP_EOL;
         echo 'remaining population is';
        print_r($population_overall);
        echo PHP_EOL;
 ...
 */
            ...
            if ($debug){
                ...
                $user_email->New_user_email(null, $email_id, $value);  //ENABLE FOR TRACKING
                $user_email->prepareStatementPDO(); //ENABLE FOR TRACKING
