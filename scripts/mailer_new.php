...
// Once the transaction has been approved, we need to complete it.
        ...
        //set some basics FOR THE EMAIL (get from email db next)

        $filename = '/assets/email/courses/polypectomy/advert1.php';
        $email_id = 'polypectomy_advert_1';
        $subject = 'GIEQS Polypectomy Upskilling Course - 17 December 1400-1800 CET';
