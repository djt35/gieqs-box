...
class Xcrud_config
{
    ...
    public static $dbhost = 'gieqs-1.cylal756awqn.eu-west-3.rds.amazonaws.com'; // Your database host, 'localhost' is default.
    ...
    public static $show_primary_ai_column = true; // Show primary auto-increment column in list view.
