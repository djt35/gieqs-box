                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent"
                                                                                    ...
                                                                                    <p style="text-align:center;color:#e3ebf6;font-family:Georgia;font-size:12px;">Email doesn't look right? <a href="<?php echo BASE_URL;?>/assets/scripts/courses/generateEmail.php?emailid=<?php echo $emailid;?>">Display in a web browser</a></p>
                                                                                    <h4
