                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent"
                                                                                    ...
                                                                                    <p style="text-align:center;color:#949494;font-family:Georgia;font-size:12px;">Email doesn't look right? <a href="<?php echo BASE_URL;?>/assets/scripts/courses/generateEmail.php?emailid=<?php echo $emailid;?>">Display in a web browser</a></p>
                                                                                                ...
                                                                                                <td class="mcnImageGroupContent"
                                                                                                    ...
                                                                                                    <center>
                                                                                                        <a href="<?php echo $value['text'];?>"
                                                                                                            target="_blank"><img
                                                                                                                alt=""
                                                                                                                src="<?php echo '<?php echo BASE_URL;?>' . $value['img'];?>"
                                                                                                                width="300"
                                                                                                ...
                                                                                                <td class="mcnImageGroupContent"
                                                                                                    ...
                                                                                                    <center>
                                                                                                        <a href="<?php echo 'https://www.vimeo.com/' . $value['video'];?>"
                                                                                                            target="_blank"><img
                                                                                                                alt=""
                                                                                                                src="<?php echo '<?php echo BASE_URL;?>' . $value['text'];?>"
                                                                                                                width="300"
                                                                                                                style="max-width:300px;padding-bottom:0;border:0;height:auto;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;vertical-align:bottom;text-align:center;"
                                                                                                                class="mcnImage"></a>
                                                                                                    </center>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent"
                                                                                    ...
                                                                                    <a href="<?php echo BASE_URL;?>/assets/scripts/unsubscribeUserEmail.php?key=<?php echo '<?php echo $key;?>';?>"
