                                                                    ...
                                                                    <div class="mcnTextContent"
                                                                        ...
                                                                        <a href="http://www.gieqs.com"
                                                                            ...
                                                                            <img class="mx-auto mt-4 mb-0" width="150"
                                                                                src="<?php echo BASE_URL;?>/assets/img/icons/gieqs_foundation_logo.png"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent"
                                                                                    ...
                                                                                    <p style="text-align:center;color:#e3ebf6;font-family:Georgia;font-size:12px;">Email doesn't look right? <a href="<?php echo BASE_URL;?>/assets/scripts/courses/generateEmail.php?emailid=71">Display in a web browser</a></p>
                                                                                    <h4
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="mcnImageGroupContent"
                                                                                                    ...
                                                                                                    <center>
                                                                                                        <a href="<?php echo BASE_URL;?>/free-videos/728"
                                                                                                            target="_blank"><img
                                                                                                                alt=""
                                                                                                                src="<?php echo BASE_URL;?>/assets/scripts/pdocrud/script/uploads/1657831438_overlay.jpg"
                                                                                                                width="450"
                                                                        ...
                                                                        <tbody class="mcnImageGroupBlockOuter">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="mcnImageGroupContent"
                                                                                                    ...
                                                                                                    <center>
                                                                                                        <a href="<?php echo BASE_URL;?>/iii"
                                                                                                            target="_blank"><img
                                                                                                                alt=""
                                                                                                                src="<?php echo BASE_URL;?>/assets/scripts/pdocrud/script/uploads/1656561259_1656477189_GIEQs III Flyer 1_1-min.png"
                                                                                                                width="450"
                                                                                                                style="max-width:450px;padding-bottom:0;border:0;height:auto;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;vertical-align:bottom;text-align:center;"
                                                                                                                class="mcnImage"></a>
                                                                                                    </center>
                                                                                    ...
                                                                                    <p
                                                                                    style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#6e84a3;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                        <p class="text-center" style="text-align:center;">Click to download the <a href="<?php echo BASE_URL;?>/assets/img/flyer/gieqs_iii_flyer.pdf">Full Flyer PDF! </a></p>                                                                                    </p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family:Helvetica;font-size:18px;padding:18px;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
                                <a class="mcnButton " title="find out more" href="<?php echo BASE_URL;?>/iii"
...
<ul>
<li>World Class <a href="<?php echo BASE_URL;?>/pages/program/faculty.php">Faculty</a></li>
<li>Latest evidence in Everyday Endoscopy</li>
<li>Revised registration pricing structure</li>
<li><strong>Discounts (up to 50%!)</strong> for <a href="<?php echo BASE_URL;?>/pages/program/symposium-group-registration.php">groups of local individuals</a> (e.g. Endoscopy Units, Local Gastroenterology Organisations) who register together</li>
<li>Option for significant discount on yearly subscription to <a href="<?php echo BASE_URL;?>/online">GIEQs Online PRO</a> - our online Everyday Endoscopy Library - at the time of registering</li>
                                                                                                ...
                                                                                                <td class="mcnImageGroupContent"
                                                                                                    ...
                                                                                                    <center>
                                                                                                        <a href="<?php echo BASE_URL;?>/iii"
                                                                                                            target="_blank"><img
                                                                                                                alt=""
                                                                                                                src="<?php echo BASE_URL;?>/assets/scripts/pdocrud/script/uploads/1656560586_image002-1.png"
                                                                                                                width="450"
                                                                                                                style="max-width:450px;padding-bottom:0;border:0;height:auto;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;vertical-align:bottom;text-align:center;"
                                                                                                                class="mcnImage"></a>
                                                                                                    </center>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent"
                                                                                    ...
                                                                                    <a href="<?php echo BASE_URL;?>/assets/scripts/unsubscribeUserEmail.php?key=<?php echo $key;?>"
