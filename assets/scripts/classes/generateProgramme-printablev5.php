                                ...
                                if ($session1data){
                                    ...
                                    if (isset($videoid)){
                                        ...
                                        if ($videosAccess->checkVimeoidPresentPublic($videoid, $past, $current)){
                                            ...
                                            $url = "window.location.href = '" . BASE_URL .  "/videos/{$videoid}'";
...
<?php
    ...
    <div class="container" style="cursor:pointer !important;" onclick="window.location.href = '<?php echo BASE_URL;?>/videos/<?php echo $value['url_video'];?>';">
            <?php }else{?>
                <div class="container">
