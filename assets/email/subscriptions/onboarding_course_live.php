                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mcnImageGroupContent"
                                                                                        ...
                                                                                        <center>
                                                                                            <a href="<?php echo BASE_URL;?>/pages/authentication/login.php?destination=gieqsonline"
                                                                                                target="_blank"><img
                                                                                                    alt=""
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent"
                                                                            ...
                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                Start by going to <a
                                                                                    href="<?php echo BASE_URL;?>/login">gieqs.com</a>
                                                                                and logging in.</p>
                                                                                                        ...
                                                                                                        <td class="mcnImageGroupContent"
                                                                                                            ...
                                                                                                            <center>
                                                                                                                <a href=""
                                                                                                                    target="_blank"><img
                                                                                                                        alt=""
                                                                                                                        src="<?php echo BASE_URL;?>/assets/img/covers/learning/screen_course_navigate.png"
                                                                                                                        width="400"
                                                                                                                        style="max-width:400px;padding-bottom:0;border:0;height:auto;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;vertical-align:bottom;text-align:center;"
                                                                                                                        class="mcnImage"></a>
                                                                                                            </center>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            <a class="mcnButton "
                                                                                                                ...
                                                                                                                href="<?php echo BASE_URL;?>/login?destination=viewasset&assetid=<?php echo $assetid;?>"
                                                                                                                target="_blank"
                                                                                                                style="font-weight:bold;letter-spacing:-0.5px;line-height:100%;text-align:center;text-decoration:none;color:#e3ebf6;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;display:block;">Access
                                                                                                                Catch Up
                                                                                                            </a>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                anytime from <a
                                                                                    href="<?php echo BASE_URL;?>/pages/authentication/login.php?destination=subscriptions">my
                                                                                    account</a>)</p>
                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                Invoice ID :
