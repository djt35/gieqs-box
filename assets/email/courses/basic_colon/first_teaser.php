                                                            ...
                                                            <div class="mcnTextContent"
                                                                ...
                                                                <a href="http://www.gieqs.com"
                                                                    ...
                                                                    <img class="mx-auto mt-4 mb-0" width="150"
                                                                        src="<?php echo BASE_URL;?>/assets/img/brand/gieqs.png"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="mcnImageGroupContent"
                                                                                            ...
                                                                                            <center>
                                                                                                <a href="<?php echo BASE_URL;?>/pages/program/program_basic_colon.php"
                                                                                                    target="_blank"><img
                                                                                                        alt=""
                                                                                                        src="<?php echo BASE_URL;?>/assets/img/covers/learning/1.png"
                                                                                                        width="400"
                                                                                                        ...
                                                                                                        <td class="mcnImageGroupContent"
                                                                                                            ...
                                                                                                            <center>
                                                                                                                <a href="<?php echo BASE_URL;?>/pages/program/program_basic_colon.php"
                                                                                                                    target="_blank"><img
                                                                                                                        alt=""
                                                                                                                        src="<?php echo BASE_URL;?>/assets/img/covers/learning/roomview1.png"
                                                                                                                        width="400"
                                                                                                                        style="max-width:400px;padding-bottom:0;border:0;height:auto;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;vertical-align:bottom;text-align:center;"
                                                                                                                        class="mcnImage"></a>
                                                                                                            </center>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            <a class="mcnButton "
                                                                                                                title="Sign Up Now"
                                                                                                                href="<?php echo BASE_URL;?>/pages/program/program_basic_colon.php"
                                                                                                                target="_blank"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent"
                                                                            ...
                                                                            <br>
                                                                            <br>
                                                                            Our privacy policy is available <a href="<?php echo BASE_URL;?>/privacy-policy"  style="mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#FFFFFF;font-weight:normal;text-decoration:underline;">here</a>.
                                                                            <br>
                                                                            <br>
                                                                            ...
                                                                            <a href="<?php echo BASE_URL;?>/assets/scripts/unsubscribeUser.php?key=<?php echo $key;?>"
