                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="mcnImageGroupContent"
                                                                                                    ...
                                                                                                    <center>
                                                                                                        <a href="<?php echo BASE_URL;?>/pages/program/program_polypectomy_upskilling.php"
                                                                                                            target="_blank"><img
                                                                                                                alt=""
                                                                                                                src="<?php echo BASE_URL;?>/assets/img/polyps/defect_scar.png"
                                                                                                                width="300"
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family:Helvetica;font-size:18px;padding:18px;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
                                <a class="mcnButton " title="Register Now" href="<?php echo BASE_URL;?>/pages/program/program_polypectomy_upskilling.php" target="_blank" style="font-weight:bold;letter-spacing:-0.5px;line-height:100%;text-align:center;text-decoration:none;color:#e3ebf6;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;display:block;">Register Now!
                                </a>
                            </td>
                        </tr>
                    </tbody>
