                                                                        ...
                                                                        <td valign="top"
																			...
																			<center>
                                                                                            <a 
                                                                                                target="_blank"><img
                                                                                                    alt=""
                                                                                                    src="<?php echo BASE_URL;?>/edm/includes/ipb.jpg"
                                                                                                    width="250"
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            <a class="mcnButton "
                                                                                                                title="Find Out More"
                                                                                                                href="<?php echo BASE_URL;?>/assets/scripts/loginNewUser.php?key=<?php echo $key;?>&signup_redirect=<?php echo $signup_redirect?>"
                                                                                                                target="_blank"
