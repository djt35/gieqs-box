...
require_once BASE_URI . '/assets/scripts/classes/formGenerator.class.php';
...
<body>
    ...
    <div class="container-fluid mx-0 pl-0 pr-0">
        ...
        <section class="header-account-page d-flex align-items-end" data-offset-top="#header-main"
