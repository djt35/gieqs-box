...
?>
    ...
    <title>Ghent International Endoscopy Symposium - Backend - GIEQs Symposium Faculty Manager</title>
                    ...
                    <div class=" col-lg-12">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-md-10 mb-4 mb-md-0">
                                <span class="h2 mb-0 text-white d-block">GIEQS Symposium Faculty Manager</span>
...
if ($local){
    ...
    $host = 'gieqs-1.cylal756awqn.eu-west-3.rds.amazonaws.com';
...
$xcrud->table('faculty'); //employees - MySQL table name

$xcrud->columns('id, email, title_printed, institution, focus, image_url, replyInvolved, confirmInvolved, confirmGuidelines, user_id', true); //employees - MySQL table name
...
$xcrud->change_type('edition','select','',array(1=>'GIEQs I', 2=>'GIEQs II', 3=>'GIEQs III',  4=>'GIEQs IV',  5=>'GIEQs V'),);  //2 table removed
$xcrud->change_type('user_id','select','',$userFunctions->getAllUsersArray(),);  //2 table removed
$xcrud->change_type('type','select','', array(1=>'Organising Committee', 2=>'International Faculty', 3=>'National Faculty',  4=>'Local Faculty',),);  //2 table removed
$xcrud->change_type('title_printed','select','', array(1=>'Consultant Gastroenterologist', 2=>'Consultant Surgeon', 3=>'Consultant Hepatologist',  4=>'Consultant Interventional Endoscopist', 5=>'Trainee Endoscopist', 6=>'Consultant Radiologist', 7=>'Consultant Oncologist', 8=>'Nurse'),);  //2 table removed
...
$curriculaesectiontable_nest = $xcrud->nested_table('Faculty Users Link', 'user_id', 'users','user_id');
$curriculaesectiontable_nest->connection($username,$password,$dbname,$host);
$curriculaesectiontable_nest->change_type('edition','select','',array(1=>'GIEQs I', 2=>'GIEQs II', 3=>'GIEQs III',  4=>'GIEQs IV',  5=>'GIEQs V'),);  //2 table removed
