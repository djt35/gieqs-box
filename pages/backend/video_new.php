...
?>
    ...
    <title>Ghent International Endoscopy Symposium - Backend - Video Manager</title>
...
$xcrud->table('video'); //employees - MySQL table name


$xcrud->columns('created, updated, duration', true); //employees - MySQL table name

$xcrud->change_type('author','select','',$userFunctions->getAllUsersArray(),);  //2 table removed
$xcrud->change_type('tagger','select','',$userFunctions->getAllUsersArray(),);  //2 table removed
$xcrud->change_type('recorder','select','',$userFunctions->getAllUsersArray(),);  //2 table removed
$xcrud->change_type('editor','select','',$userFunctions->getAllUsersArray(),);  //2 table removed
$xcrud->change_type('active','select','',array(0=>'0 - Not shown, not tagged, inactive', 1=>'1 - Shown on Live Site', 2=>'Not shown , needs tagging', 3=>'3 - Shown on Live Site and available FREE', 4=>'4 - Submit for Moderation prior to Live Site'),);  //2 table removed
$xcrud->fields('description', true);
