...
//require($_SERVER['DOCUMENT_ROOT'].'/config/global-xcrud-gieqs.php');
if($_SESSION['relative'])
    {
        require($_SERVER['DOCUMENT_ROOT'].'/'.$_SESSION['relative'].'/config/global-xcrud-gieqs.php');	
    }
    else
    {
        require($_SERVER['DOCUMENT_ROOT'].'/config/global-xcrud-gieqs.php');
...
<button class="btn btn-fill-gieqsGold btn-sm mx-2 my-3" onclick="location.reload()">Show All Registrations</button>
