...
?>
    ...
    <title>GIEQs IV - Meet our Sponsors</title>
    <meta charset="utf-8">
 <meta http-equiv="content-type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description"
        content="Meet our generous sponsors who make GIEQs IV possible">
...
<!-- 
                    ...
                    <div class="col-lg-4 col-md-4 col-4 p-3">
                        <a href="https://www.pentax-medical.com" target="_Blank">
                            <img class="logo" alt="Pentax Medical" src="https://cdn.endoscopyonair.com/wp-content/uploads/2021/05/PentaxLogo_RGB_900.png">
                        </a>
                    </div>
                   ...
                   <!--  <div class="col-lg-2 col-md-3 col-4 p-3">
                    ...
                    <div class="col-lg-2 col-md-3 col-4 p-3">
                        <a href="https://www.astellas.com/en/" target="_Blank">
                            <img class="logo" alt="Astellas" src="https://www.astellas.com/themes/custom/astellas_v2/logo.svg">
                        </a>
                    </div>
...
<!--                 Other Sponsors
 -->           <div class="row my-4">
                ...
                <div class="col-lg-2 col-md-4 col-4 py-1">
                        <a href="https://www.erbe-med.com/de-en/global-home/" target="_Blank">
                            <img class="logo" alt="Erbe" src="https://de.erbe-med.com/fileadmin/images/Unternehmen/Presse/PR_Logo_mit_Claim_Erbe_Elektromedizin.jpg">
                        </a>
                    </div> 
                   <!--  <div class="col-lg-2 col-md-4 col-4 py-1">
 ...
 -->
                ...
                <div class="client-group row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-2 col-md-3 col-4 p-3">
                        <img class="logo" alt="BSGIE" src="<?php echo BASE_URL . '/assets/img/brand/bsgie.png';?>">
                    </div>

                    <div class="col-lg-2 col-md-3 col-4 p-3">
                        <img class="logo" alt="ESGE" src="https://www.gieqs.com/assets/scripts/pdocrud/script/uploads/1685007372_ESGE_ Endorsed-2023-Logo.png">
                    </div>
