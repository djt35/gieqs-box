                        ...
                        <div class="col-lg-9">
                            ...
                            <article>
                                ...
                                <p><strong>October 2021</strong> was our second edition - expanded faculty and more
                                    ...
                                    <p><strong>September 2022</strong> was our third edition - fantastic visuals and deconstruction, our best feedback yet and superstar faculty.</p>
                                <p><strong>October 5<sup>th</sup> and 6<sup>th</sup> 2023</strong> will be the dates
                                ...
                                <a href="<?php echo BASE_URL;?>/pro-content/175&action=register" class="btn btn-fill-gieqsGold btn-lg my-2" role="button">Register Now!</a>
                                <a href="<?php echo BASE_URL;?>/pages/program/symposium-group-registration-4.php" class="btn btn-fill-gieqsGold btn-lg my-2" role="button">Explore Group Registration</a>
                                ...
                                <p><a href="<?php echo BASE_URL;?>/pages/program/program_4.php">View
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <p><strong>Dr Matthew Banks</strong></p>
                                            </td>
                                            <td>
                                                <p>Opinion Leader in Upper GI Imaging</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <p><strong>Dr Marietta Iacucci</strong></p>
                                            </td>
                                            <td>
                                                <p>Opinion Leader in IBD in Endoscopy</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <p><strong>Dr Siwan Thomas-Gibson</strong></p>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <p><strong>Dr Pieter Siersema</strong></p>
                                            </td>
                                            <td>
                                ...
                                <p>To lock in this unique experience for the best possible price we advise you to
                                    register as soon as possible, certainly before the <strong>early bird deadline of
                                        4<sup>th</sup> September 2023.</strong></p>
                                <div class="btn-container mt-5 text-center">
                                <a href="<?php echo BASE_URL;?>/pro-content/175&action=register" class="btn btn-fill-gieqsGold btn-lg my-2" role="button">Register Now!</a>
                                ...
                                <hr>
                                <h1>Join us Virtually, 5th and 6<sup>th</sup> October 2023</h1>
