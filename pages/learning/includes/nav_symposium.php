...
if (isset($access_token) && ($assetManager->checkAssetToken($asset_id_pagewrite, $access_token, false) === true)){  //is set and is valid for this course and there are tokens remaining
    ...
    $link_yellow_button_token = BASE_URL . "/pro-content/95&access_token=" . $access_token . "&action=register";

}else{
    $access_token_present = false;
    $link_yellow_button_no_token = BASE_URL . "/pro-content/95&action=register";
}
...
<nav class="mt-2 navbar navbar-horizontal navbar-expand-lg navbar-dark gieqsGold sticky-top" style="z-index: 1 !important;">
    <div class="container">
        <a class="navbar-brand" href="<?php echo BASE_URL; ?>/pro-content/95"><?php echo 'Symposium.  Edition III';?>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-warning">
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item">
                    <a <a href="<?php echo BASE_URL;?>/pro-content/95" class="nav-link nav-link-icon cursor-pointer">
                ...
                <li class="nav-item">
                    <a href="<?php echo BASE_URL;?>/pro-content/132" class="nav-link nav-link-icon cursor-pointer">
