...
<body>
    ...
    <body>
        ...
        <div class="main-content">
                        ...
                        <div class=" col-lg-12">
                            ...
                            <div class="row align-items-center mb-4">
                                <div class="col-auto mb-4 mb-md-0">
                                    <span class="h2 mb-0 text-white text-bold d-block">Welcome to your GIEQs Statistics.
            ...
            require BASE_URI . '/pages/learning/assets/materialNav.php'; -->
...
<?php 
error_reporting(E_ALL); 
$completionArrayAsset = $usersMetricsManager->userCompletionAsset($userid, 7, false);
?>
