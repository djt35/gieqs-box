                        ...
                        <div class=" col-lg-12">
                            ...
                            <div class="row align-items-center mb-4">
                                <div class="col-auto mb-4 mb-md-0">
                                    <span class="h2 mb-0 text-white text-bold d-block">Colonoscopy
...
<section class="slice delimiter-bottom m-0 p-2" id="statistics">
    ...
    <div class="mb-5">
        ...
        <span class="d-block h5 text-white mr-2 mb-1">i am a (colonoscopy)</span>
        
        <span class="d-block h6 text-white mr-2 mb-1 mt-4"></span>

                          
                        <ul>
                            <li>never performed colonoscopy</li>
                            <li>starter (0-50 colonoscopies)</li>
                            <li>beginner (50-200 colonoscopies)</li>
                            <li>intermediate (200-1000) colonoscopies</li>
                            <li>experienced colonoscopist in independent practise looking for upskilling</li>
                        </ul>
                </div>
            </div>
        </div>
