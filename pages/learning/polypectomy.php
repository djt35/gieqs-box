                        ...
                        <div class=" col-lg-12">
                            ...
                            <div class="row align-items-center mb-4">
                                <div class="col-auto mb-4 mb-md-0">
                                    <span class="h2 mb-0 text-white text-bold d-block">Polypectomy
...
<section class="slice delimiter-bottom m-0 p-2" id="statistics">
    ...
    <div class="mb-5">
        ...
        <span class="d-block h5 text-white mr-2 mb-1">i am looking for (Polypectomy)</span>
        
        <span class="d-block h6 text-white mr-2 mb-1 mt-4"></span>

                          
                        <ul>
                            <li>polyp assessment (cancer / no cancer)</li>
                            <li>polyp assessment (difficulty of resection)</li>
                            <li>cold snare polypectomy (en bloc)</li>
                            <li>cold snare polypectomy (piecemeal)</li>
                            <li>hot snare polypectomy (en bloc)</li>
                            <li>hot snare polypectomy (piecemeal, endoscopic mucosal resection), easy (SMSA 1/2)</li>
                            <li>intermediate (SMSA 3)</li>
                            <li>difficult (SMSA 4, SMSA+)</li>
                            <li>non-lifting polyps</li>
