...
$light_theme = true;
      ...
      require BASE_URI . '/head_nocss_esge.php';
...
$client = new Vimeo($vimeo_client_id, $vimeo_client_secret, $vimeo_token);
    ...
    <!--Page title-->
    <title>ESGE Online Endoscopy Trainer</title>
...
<body>
    <header class="header header-transparent" id="header-main">
        ...
        <?php require BASE_URI . '/topbar_esge.php';?>

        <!-- Main navbar -->

        <?php //require BASE_URI . '/pages/learning/includes/nav.php';?>
        <?php require BASE_URI . '/nav_esge.php';?>
            ...
            <div class="container pt-4 pt-lg-4" id="mainContainer">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb breadcrumb-links p-0 m-0">
                        <li class="breadcrumb-item"><a href="<?php echo BASE_URL . '/pages/learning/index.php'?>">ESGE player
                                </a></li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="registerInterestLabel" style="color: #F7941F;">Thank-you for
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitPreRegister" type="button" class="btn-small text-black"
                        style="background-color: #F7941F;">Submit</button>
                </div>
            </div>
        </div>
    </div>

    <?php require BASE_URI . '/footer_esge.php';?>
