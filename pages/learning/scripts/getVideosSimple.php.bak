...
<?php
                ...
                foreach ($videos as $key=>$value){
                    ...
                    if ($a == 1){
                        ...
                        ?>
                       <!--  <div class="card-deck"> -->
                         <div class="d-flex flex-row flex-wrap align-items-stretch mt-1 pt-0 px-0 text-white">                    <?php }
...
?>          
                ...
                <div class="card-footer">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <a href="<?php echo BASE_URL . '/videos/' . $value['id'] . '&referid=' . $data['referringUrl']; ?>" class="btn btn-sm text-white gieqsGoldBackground">View</a>
                        </div>
