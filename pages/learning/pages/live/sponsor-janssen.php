          ...
          <div class="col-lg-12 text-center justify-content-center mb-3">
              ...
              <div class="text-center d-flex justify-content-center">
                <a href="https://www.janssen.com/immunology/gastroenterology" target="_blank" class="p-4">
                  <img alt="Janssen" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/Janssen/jsn_ta_imm_jj_rev_rgb.png"
          ...
          <div class="card bg-gradient-dark border-0 p-5 mt--150">
            <div class="card-body">
              ...
              <p class="mt-4 mb-0 text-white">
                ...
                <br>
	      	<a href="<?php echo BASE_URL;?>/assets/img/sponsors-pages/Janssen/PDF Janssens.pdf" target="_blank">
                  <img src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/Janssen/PDF Janssens.png" alt="PDF Acertys" style="max-width:100%;max-height:200px">
                </a>
              </p>
            </div>
          </div>
    ...
    <section class="slice slice-lg">
      <div class="container">
        <div class="row row-grid">
          <div class="col-lg-3">
            <div class="p-3">
                <img alt="Image" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/Janssen/Image 1.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
            </div>
          </div>
          <div class="col-lg-3">
            <div class="p-3">
                <img alt="Image" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/Janssen/Image 2b.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
            </div>
          </div>
        </div>
      </div>
