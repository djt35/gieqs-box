          ...
          <div class="col-lg-12 text-center justify-content-center mb-3">
              ...
              <div class="text-center d-flex justify-content-center">
                <a href="https://www.bostonscientific.com/en-EU/medical-specialties/gastroenterology.html" target="_blank">
                  <img alt="Boston Scientific" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/boston/Boston.png"
          ...
          <div class="col-lg-3">
            <div class="p-3">
              <a href="https://www.bostonscientific.com/en-EU/products/direct-visualization-systems/spyglass-ds-direct-visualization-system.html" target="_blank">
                <img alt="Image" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/boston/Boston 1.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
              </a>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="p-3">
              <a href="https://www.bostonscientific.com/en-EU/products/stents-gastrointestinal/axios-stent-and-electrocautery-enhanced-delivery-system.html" target="_blank">
                <img alt="Image" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/boston/Boston 2.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
              </a>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="p-3">
              <a href="https://www.bostonscientific.com/en-EU/products/single-use-scopes/exalt-model-d.html" target="_blank">
                <img alt="Image" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/boston/Boston 3.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
              </a>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="p-3">
              <a href="https://www.bostonscientific.com/en-EU/products/infection-prevention/orca.html" target="_blank">
                <img alt="Image" src="<?php echo BASE_URL;?>/assets/img/sponsors-pages/boston/Boston 4.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
              </a>
            </div>
          </div>
        </div>
