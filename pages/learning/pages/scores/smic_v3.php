 ...
 -->
		...
		<form action="adminGenerateUserEmail.php" method="post">
            <fieldset>
				...
				$formv1->generateSelectCustom ('Is there a demarcation area (of regular to irregular pit / vascular pattern) within the polyp:', 'demarcation', 'factor', array('0' => '0 - No demarcated area', '1' => '1 - Demarcated area'), 'Click for an example');
				echo '<br/>';
			
                $formv1->generateSelectCustom ('Highest classification of the demarcation area :', 'demarcation_imaging', 'factor', array('1' => '1 - JNET 1 - completely regular', '2' => '2 - JNET 2A - completely regular', '3' => '3 - JNET 2B - irregular but with some maintained structure (regularly irregular)', '4' => '4 - JNET 3 - completely irregular',), 'Highest Imaging Grade of the Demarcation Area?');
				echo '<br/>';
				...
				echo '<br/>';
				$formv1->generateSelectCustom ('Location of lesion :', 'location', 'factor', array('1' => '1 - rectum', '2' => '2 - other location', ), 'Location of lesion');
				echo '<br/>';
				$formv1->generateSelectCustom ('Morphology :', 'morphology', 'factor', array('1' => '1 - Granular - nodular surface', '2' => '2 - any Non-granular component - flat and shiny surface', '3' => '3 - serrated or other'), 'Morphology of lesion');
				echo '<br/>';
				$formv1->generateSelectCustom ('Paris classification :', 'paris', 'factor', array('1' => '1 - 0-IIa - No Nodule', '2' => '2 - 0-Is - Only a nodule (≥10mm)', '3' => '3 - 0-IIa+Is - Flat with a large nodule (≥10mm)'), 'Paris classification of lesion');
				echo '<br/>';
