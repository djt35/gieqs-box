...
<nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar" id="navbar-main">
    <div class="container px-lg-0">
        <!-- Logo -->
        <a class="navbar-brand mr-lg-5" href="https://www.esge.com">
            <img alt="Image placeholder" src="<?php echo BASE_URL;?>/assets/img/brand/esge_logo.png" id="navbar-logo"
                style="height: 50px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-main-collapse">
            <ul class="navbar-nav align-items-lg-center">
               ...
               <!--  <li class="nav-item active">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo BASE_URL; ?>/pages/learning/pages/curriculum/curriculum_generic_esge.php?id=4">Curricula</a>
                </li>

                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo BASE_URL; ?>/pages/learning/viewer_esge.php?id=872">Webinars</a>
                </li>

                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo BASE_URL; ?>/pages/learning/viewer_esge.php?id=890">Podcasts</a>
                </li>


                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo BASE_URL; ?>/pages/learning/pages/general/show_subscription_esge.php?assetid=83">myESGEtutor</a>
                </li>
